    ...
    public function run(): void
    {
        ...
        DB::transaction(function () use ($permissions) {
            ...
            $buyerRole->syncPermissions([
                ...
                'view_purchase_reports','edit_own_profile',
            ]);

            $accountingRole->syncPermissions([
                'view_suppliers','view_orders',
                'view_invoices','create_invoices','edit_invoices',
                'process_payments','view_accounting_reports',
                'edit_own_profile',
            ]);

            $supplierRole->syncPermissions([
                'view_own_orders','create_quotes','edit_quotes',
                'create_invoices','edit_invoices','edit_own_profile',
            ]);

            $authorizerRole->syncPermissions([
                'view_suppliers','view_orders','view_invoices','view_quotes',
                'approve_suppliers','approve_orders','reject_orders',
                'approve_invoices','reject_invoices','approve_quotes',
                'view_purchase_reports','view_accounting_reports',
                'edit_own_profile',
            ]);
