...
class ImportBudget2026Gasomex extends Command
{
    protected $signature = 'budgets:import-2026-gasomex
        {--file=docs/Presupuesto Anual 2026 GASOMEX.xlsx : Ruta del workbook}
        {--year=2026 : Año fiscal destino}
        {--status=PLANIFICACION : Estatus para presupuestos nuevos}
        {--dry-run : Solo analizar sin persistir}';

    protected $description = 'Analiza o importa el presupuesto anual 2026 de GASOMEX desde el workbook aprobado.';

    public function __construct(
        private readonly Budget2026GasomexImportService $importService
    ) {
        parent::__construct();
    }
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            $outputFile = $outputDir . '/budget-import-2026-gasomex-' . now()->format('Ymd-His') . '.json';
