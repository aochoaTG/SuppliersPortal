...
class ImportBudget2026Sma extends Command
{
    protected $signature = 'budgets:import-2026-sma
        {--file=docs/Presupuesto Anual 2026 SMA.xlsx : Ruta del workbook}
        {--year=2026 : A̱o fiscal destino}
        {--status=PLANIFICACION : Estatus para presupuestos nuevos}
        {--dry-run : Solo analizar sin persistir}';

    protected $description = 'Analiza o importa el presupuesto anual 2026 de SMA desde el workbook aprobado.';

    public function __construct(
        private readonly Budget2026SmaImportService $importService
    ) {
        parent::__construct();
    }
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            $outputFile = $outputDir . '/budget-import-2026-sma-' . now()->format('Ymd-His') . '.json';
