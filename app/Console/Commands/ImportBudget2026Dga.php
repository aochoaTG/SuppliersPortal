...
class ImportBudget2026Dga extends Command
{
    protected $signature = 'budgets:import-2026-dga
        {--file=docs/Presupuesto Anual 2026 DGA.xlsx : Ruta del workbook}
        {--year=2026 : Año fiscal destino}
        {--status=PLANIFICACION : Estatus para presupuestos nuevos}
        {--dry-run : Solo analizar sin persistir}';

    protected $description = 'Analiza o importa el presupuesto anual 2026 de Diaz Gas desde el workbook aprobado.';

    public function __construct(
        private readonly Budget2026DgaImportService $importService
    ) {
        parent::__construct();
    }
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            $outputFile = $outputDir . '/budget-import-2026-dga-' . now()->format('Ymd-His') . '.json';
