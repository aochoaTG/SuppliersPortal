...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="ti ti-receipt-tax me-1"></i> Impuestos</h5>
    </div>
    <div class="card-body">
        @if (session('success'))
        ...
        <div class="table-responsive">
            <table id="taxesTable" class="table-bordered table-hover w-100 table">
                <thead class="table-light">
                    <tr>
                        <th style="width: 60px;">#</th>
                        <th>Nombre</th>
                        <th class="text-end" style="width: 140px;">Tasa (%)</th>
...
<script>
    ...
    $(function() {
        $('#taxesTable').DataTable({
            ...
            pageLength: 50,
            buttons: [{
                    text: '<i class="ti ti-plus me-1"></i> Nuevo impuesto',
