    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row g-2">
                ...
                <div class="col-md-4">
                    <label for="justification" class="form-label form-label-sm">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="justification" name="justification"
                            class="form-control form-control-sm @error('justification') is-invalid @enderror"
                            value="{{ old('justification', $requisition->justification ?? '') }}"
                            placeholder="Justificación detallada" maxlength="500">
                        @error('justification')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
